...
if("TRUE" STREQUAL "TRUE")
  set(plc_out_SOURCE_PREFIX /home/projn7cellule/tuto_ahmed/Workspace_Cell/catkin_ws/src/plc_out)
  set(plc_out_DEVEL_PREFIX /home/projn7cellule/tuto_ahmed/Workspace_Cell/catkin_ws/devel)
  set(plc_out_INSTALL_PREFIX "")
  set(plc_out_PREFIX ${plc_out_DEVEL_PREFIX})
else()
  set(plc_out_SOURCE_PREFIX "")
  set(plc_out_DEVEL_PREFIX "")
  set(plc_out_INSTALL_PREFIX /home/projn7cellule/tuto_ahmed/Workspace_Cell/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'plc_out' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ahmed LIMEM <ahmed.limem@etudiant-enit.utm.tn>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'plc_out' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/projn7cellule/tuto_ahmed/Workspace_Cell/catkin_ws/src/plc_out/${idir}'.  Ask the maintainer 'Ahmed LIMEM <ahmed.limem@etudiant-enit.utm.tn>' to fix it.")
    endif()
...
set(plc_out_EXPORTED_TARGETS "plc_out_generate_messages_cpp;plc_out_generate_messages_lisp;plc_out_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${plc_out_dep}_FOUND)
      find_package(${plc_out_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${plc_out_dep} REQUIRED ${depend_list})
  endif()
