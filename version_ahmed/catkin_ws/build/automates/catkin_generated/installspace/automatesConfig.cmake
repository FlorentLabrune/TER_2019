...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'automates' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/projn7cellule/tuto_ahmed/Workspace_Cell/catkin_ws/install/${idir}'.  Ask the maintainer 'etudiant <etudiant@todo.todo>' to fix it.")
    endif()
