...
if("FALSE" STREQUAL "TRUE")
  set(plc_out_SOURCE_PREFIX /home/projn7cellule/cell_ros_ws/src/plc_out)
  set(plc_out_DEVEL_PREFIX /home/projn7cellule/cell_ros_ws/devel)
  set(plc_out_INSTALL_PREFIX "")
  set(plc_out_PREFIX ${plc_out_DEVEL_PREFIX})
else()
  set(plc_out_SOURCE_PREFIX "")
  set(plc_out_DEVEL_PREFIX "")
  set(plc_out_INSTALL_PREFIX /home/projn7cellule/cell_ros_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plc_out' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/projn7cellule/cell_ros_ws/install/${idir}'.  Ask the maintainer 'Ahmed LIMEM <ahmed.limem@etudiant-enit.utm.tn>' to fix it.")
    endif()
